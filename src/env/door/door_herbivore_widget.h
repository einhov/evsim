#ifndef DOOR_HERBIVORE_WIDGET_H
#define DOOR_HERBIVORE_WIDGET_H
...
class door_herbivore_widget : public QWidget {
    Q_OBJECT

public:
	explicit door_herbivore_widget(evsim::door::herbivore_neat *species, size_t avg_window, QWidget *parent = 0);
	~door_herbivore_widget();
...
private:
	evsim::door::herbivore_neat *species;
	Ui::door_herbivore_widget *ui;
};
