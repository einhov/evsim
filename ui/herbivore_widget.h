#ifndef HERBIVORE_WIDGET_H
#define HERBIVORE_WIDGET_H
...
class herbivore_widget : public QWidget {
    Q_OBJECT

public:
    explicit herbivore_widget(evsim::species_neat *species, QWidget *parent = 0);
    ~herbivore_widget();
...
private:
	...
	evsim::species_neat *species;
    Ui::herbivore_widget *ui;
