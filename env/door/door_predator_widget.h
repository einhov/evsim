#ifndef DOOR_PREDATOR_WIDGET_H
#define DOOR_PREDATOR_WIDGET_H
...
class door_predator_widget;
}

class door_predator_widget : public QWidget {
    Q_OBJECT

public:
	explicit door_predator_widget(evsim::door::predator_neat *species, size_t avg_window, QWidget *parent = 0);
	~door_predator_widget();
...
private:
	evsim::door::predator_neat *species;
	Ui::door_predator_widget *ui;
};
